                ...
                <div class="p-6 pt-0">
                    <form @submit.prevent="login">
                        ...
                        <div class="mt-4 flex items-center justify-end gap-x-2">
                            <button @click="goToSignUp" class="inline-flex items-center justify-center rounded-md text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 hover:bg-accent hover:ring hover:ring-white h-10 px-4 py-2 duration-200"
                                >Sign Up</button>
                            <button
...
const login = async () => {
    ...
    try {
        ...
        console.error(`Fail to login status ${err.response.status} : ${err.response.data.error}`)
    }
